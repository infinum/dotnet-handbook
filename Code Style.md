...
* Keep you methods as simple as possible and break them into multiple methods if they start to gain complexity (or if you can reuse specific parts of it). If you need comments to describe your method, it is possible that it is too complex.
