...
- To use the validator we should **register** it in the Startup class in the ConfigureServices method like this:
...
### Configuration checker
 ...
 With fluent validation, we can validate **any** class, and nothing is stopping us from using it to validate
...
- Create validators and specify the rules. Pay attention to including the `.NotEmpty()` method, but you can add any validation you deem to be needed
